            ...
            <Box sx={styles.pokeBox}>
                ...
                {!pokemons.length ?
                    <Container maxWidth="md" sx={styles.loading}>
                        {loading?<img alt="loading" className="loading" src="./images/pokeball_gray.png" style={{ height: "4rem" }} />:null}
                    </Container> :
                    <InfiniteScroll
                        ...
                        loader={
                            <Container maxWidth="md" sx={{ backgroundColor: 'white', textAlign: 'center', height: '2.5rem' }}>
                                {loading?<img alt="loading" className="loading" src="./images/pokeball_gray.png" />:null}
                            </Container>
                        }
                    >
